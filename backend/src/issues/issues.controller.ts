...
export class IssuesController {
  ...
  getByProject(
    ...
    return this.issuesService.getIssuesByProject(projectId, status);
  }
  ...
  getBySprint(@Param('sprintId') sprintId: string) {
    return this.issuesService.getIssuesBySprint(sprintId);
  }
