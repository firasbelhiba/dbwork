      ...
      <Link href={`/issues/${issue._id}`} className="block">
        ...
        <div className="flex items-center gap-2 mb-2 flex-wrap">
          ...
          {issue.isVisible === false && (
            <div
              className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700"
