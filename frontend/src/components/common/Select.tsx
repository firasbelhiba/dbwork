  ...
  ({ className, label, error, helperText, options, children, ...props }, ref) => {
    return (
      <div className="w-full">
        ...
        <select
          className={cn(
            'flex h-11 sm:h-10 w-full rounded-md border-2 border-gray-300 dark:border-dark-300 bg-white dark:bg-dark-400 px-3 py-2 text-base sm:text-sm text-gray-900 dark:text-gray-100',
