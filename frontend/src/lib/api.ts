...
export const projectsAPI = {
  ...
  addMember: (id: string, data: { userId: string; projectRoles?: string[] }) => api.post(`/projects/${id}/members`, data),
  removeMember: (id: string, userId: string) => api.delete(`/projects/${id}/members/${userId}`),
  updateMemberRoles: (id: string, userId: string, projectRoles: string[]) => api.patch(`/projects/${id}/members/${userId}/roles`, { projectRoles }),
