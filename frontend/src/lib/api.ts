...
export const projectsAPI = {
  ...
  addMember: (id: string, data: { userId: string; projectRole?: string }) => api.post(`/projects/${id}/members`, data),
  removeMember: (id: string, userId: string) => api.delete(`/projects/${id}/members/${userId}`),
  updateMemberRole: (id: string, userId: string, projectRole: string) => api.patch(`/projects/${id}/members/${userId}/role`, { projectRole }),
