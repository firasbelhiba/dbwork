            ...
            <div className="space-y-6">
              ...
              {user.preferences && (
                <div className="bg-white dark:bg-dark-400 rounded-xl shadow-sm border border-gray-200 dark:border-dark-300 p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Theme</label>
                      <p className="text-sm text-gray-900 dark:text-gray-100 mt-1 capitalize">{user.preferences.theme}</p>
                    </div>
                    <div>
                      <label className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Language</label>
                      <p className="text-sm text-gray-900 dark:text-gray-100 mt-1">{user.preferences.language || 'English'}</p>
                    </div>
                    <div>
                      <label className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Email Notifications</label>
                      <div className="mt-2 space-y-2">
                        {user.preferences.emailNotifications && Object.entries(user.preferences.emailNotifications).map(([key, value]) => (
                          <div key={key} className="flex items-center gap-2">
                            <div className={`w-2 h-2 rounded-full ${value ? 'bg-success-500' : 'bg-gray-400'}`} />
